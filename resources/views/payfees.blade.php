...
<ul class="nav nav-tabs generic-tab pb-30px" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="statements-tab" data-toggle="tab" href="#statements" role="tab"
            aria-controls="statements" aria-selected="false">
            Statements
        </a>
    </li>
</ul>
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="earning" role="tabpanel" aria-labelledby="earning-tab">
        <div class="row">
                ...
                <div class="card card-item dashboard-info-card">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            ...
                            <h5 class="card-title pt-2 fs-26"></h5>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
                ...
                <div class="card card-item dashboard-info-card">
                    <div class="card-body d-flex align-items-center">
                        <div class="icon-element flex-shrink-0 bg-3 text-white">
                            <svg class="svg-icon-color-white" width="40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 478.856 478.856"
                                xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                                            d="M406.872,160.017c-0.005,0-0.011,0-0.016,0h-400c-3.782-0.004-6.852,3.058-6.856,6.84c0,0.005,0,0.011,0,0.016v192
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M360.36,128.185l-320-72c-1.776-0.397-3.637-0.075-5.176,0.896c-1.537,0.979-2.624,2.526-3.024,4.304l-16,72
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M321.504,88.513l-192-80c-3.337-1.391-7.182,0.038-8.8,3.272l-16,32c-1.807,3.342-0.563,7.517,2.78,9.324
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M326.352,192.017h-63.496c-3.786,0-6.856,3.07-6.856,6.856c0,3.786,3.07,6.856,6.856,6.856h63.496
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M198.856,192.473c-38.881,0-70.4,31.519-70.4,70.4c0.04,38.864,31.536,70.36,70.4,70.4c38.881,0,70.4-31.519,70.4-70.4
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M390.856,214.873c-42.4,0-88,10.016-88,32v192c0,21.984,45.6,32,88,32c42.4,0,88-10.016,88-32v-192
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M134.856,320.009H74.384l-28.672-31.36v-52l31.664-30.92h57.48c3.786,0,6.856-3.07,6.856-6.856
                                ...
                                <g>
                                    <g>
                                        <path
                                            d="M202.856,254.873h-8c-2.488,0-4-1.392-4-2c0-0.608,1.512-2,4-2h20c4.418,0,8-3.582,8-8s-3.582-8-8-8h-8
            ...
            <div class="col-lg-4 responsive-column-half"></div>
            <div class="col-lg-4 responsive-column-half"><div class="my-auto text-center">
                <a data-toggle="modal" data-target="#fund-modal" href="#fund-modal" class="btn btn-outline-primary font-w-600 my-auto text-nowrap">Fund wallet</a>
            </div></div>
            <div class="col-lg-4 responsive-column-half"></div>
                            ...
                            <tr>
                                <th scope="row">
                                    ...
                                    <ul class="generic-list-item">
                                        ...
                                        <li>
                                            <span class="text-black mr-1">Address:</span>329 Queensberry Street, North
